...
/**
 * 微信支付包装类，包含不同场景的业务逻辑请求。
 *
 * @author shinnlove.jinsheng
 * @version $Id: WXPay.java, v 0.1 2018-07-08 上午10:33 shinnlove.jinsheng Exp $$
 */
public class WXPay {
    ...
    public String requestWithoutCert(String urlSuffix, Map<String, String> reqData,
        ...
        // 再使用`httpclient`请求
        return this.wxPayRequest.requestWithoutCert(urlSuffix, msgUUID, reqBody, connectTimeoutMs,
