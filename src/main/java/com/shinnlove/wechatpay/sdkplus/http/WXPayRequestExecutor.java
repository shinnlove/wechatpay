...
import com.shinnlove.wechatpay.sdkplus.config.WXPayGlobalConfig;
...
public class WXPayRequestExecutor {
     ...
     * @throws Exception
     */
    public String doRequest(WXPayMchConfig config, String url, String requestBody, boolean needCert)
                                                                                                    throws Exception {
        if (needCert) {
            return requestWithCert(config, url, "", requestBody, globalConfig.isAutoReport());
        } else {
            return requestWithoutCert(config, url, "", requestBody, globalConfig.isAutoReport());
        }
    }
     ...
     * @throws Exception
     */
    private String requestOnce(WXPayMchConfig mchConfig, final String domain, String urlSuffix,
                               String uuid, String data, int connectTimeoutMs, int readTimeoutMs,
     ...
     * @throws Exception
     */
    private String request(WXPayMchConfig mchConfig, String urlSuffix, String uuid, String data,
        ...
        IWXPayDomain.DomainInfo domainInfo = globalConfig.getDomain().getDomain(
            WXPayConfigImpl.getInstance());
        if (domainInfo == null) {
            throw new Exception("WXPayConfig.getWXPayDomain().getDomain() is empty or null");
        }
        try {
            String result = requestOnce(mchConfig, domainInfo.domain, urlSuffix, uuid, data,
     ...
     * @return
     */
    public String requestWithoutCert(WXPayMchConfig mchConfig, String urlSuffix, String uuid,
                                     String data, boolean autoReport) throws Exception {
        return request(mchConfig, urlSuffix, uuid, data, globalConfig.getHttpConnectionTimeoutMs(),
            globalConfig.getHttpReadTimeoutMs(), false, autoReport);
    }
     ...
     * @throws Exception
     */
    public String requestWithCert(WXPayMchConfig mchConfig, String urlSuffix, String uuid,
                                  String data, boolean autoReport) throws Exception {
        return request(mchConfig, urlSuffix, uuid, data, globalConfig.getHttpConnectionTimeoutMs(),
            globalConfig.getHttpReadTimeoutMs(), true, autoReport);
    }

    /**
     * Setter method for property globalConfig.
     *
     * @param globalConfig value to be assigned to property globalConfig
     */
    public void setGlobalConfig(WXPayGlobalConfig globalConfig) {
