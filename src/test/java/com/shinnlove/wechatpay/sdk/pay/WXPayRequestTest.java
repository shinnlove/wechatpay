 ...
 * @version $Id: WXPayRequestTest.java, v 0.1 2018-07-08 上午10:55 shinnlove.jinsheng Exp $$
 */
public class WXPayRequestTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        result = wxPayRequest.requestWithCert("/secapi/pay/refund", "1213uuid", data2, 10000,
            10000, true);
        System.out.println(result);
