 ...
 * @version $Id: WXPayTest.java, v 0.1 2018-07-08 上午10:52 shinnlove.jinsheng Exp $$
 */
public class WXPayTest {
    ...
    public WXPayTest() throws Exception {
        config = WXPayConfigImpl.getInstance();
        wxpay = new WXPay(config);
        total_fee = "1";
        // transaction_id = "1001510314201508280733586039";
        out_trade_no = "6b80dfdd21af247b584a47d53d0a130c";
    }
    ...
    public void doGetSandboxSignKey() throws Exception {
        ...
        String result = wxPay.requestWithoutCert(
            "https://api.mch.weixin.qq.com/sandbox/pay/getsignkey", data, 10000, 10000);
